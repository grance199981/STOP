...
from spiking_jelly_neuron import trace_layer
...
class Block(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, dropout, neuron: callable = None, **kwargs):
        ...
        self.relu1 = neuron(layer=self.conv1, bn=self.bn1, **kwargs)
        self.relu2 = neuron(layer=self.conv2, bn=self.bn2, **kwargs)
...
class New_PreActBlock(nn.Module):
    '''Pre-activation version of the BasicBlock.'''
    expansion = 1

    def __init__(self, in_channels, out_channels, stride, dropout, neuron: callable = None, **kwargs):
        super(New_PreActBlock, self).__init__()
        whether_bias = True
        self.bn1 = nn.BatchNorm2d(in_channels)
        ...
        #self.relu1 = neuron(layer=None, bn=self.bn1, **kwargs)
        self.relu1 = neuron(layer=self.conv1, bn=self.bn2, **kwargs)
        self.relu2 = neuron(layer=self.conv2, bn=None, **kwargs)
...
class PreActBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride, dropout, neuron: callable = None, **kwargs):
        ...
        self.relu1 = neuron(layer=None, bn=self.bn1, **kwargs)
        self.relu2 = neuron(layer=self.conv1, bn=self.bn2, **kwargs)
...
class PreActResNet(nn.Module):
    ...
    def __init__(self, params, block, num_blocks, num_classes, dropout, neuron: callable = None, **kwargs):
...
def spiking_resnet18(params, neuron: callable = None, num_classes=10,  neuron_dropout=0, **kwargs):
    return PreActResNet(params, PreActBlock, [2, 2, 2, 2], num_classes, neuron_dropout, neuron=neuron, **kwargs)


def spiking_resnet34(params, neuron: callable = None, num_classes=10,  neuron_dropout=0, **kwargs):
    return PreActResNet(params, PreActBlock, [3, 4, 6, 3], num_classes, neuron_dropout, neuron=neuron, **kwargs)
